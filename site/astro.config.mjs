...
export default defineConfig({
  ...
  integrations: [
    starlight({
      ...
      sidebar: [
        { label: "Start", items: [{ slug: "getting-started" }, { slug: "installation" }, { slug: "auth" }] },
        { label: "Concepts", items: [{ slug: "safety-model" }, { slug: "output" }] },
        { label: "Guides", items: [{ slug: "inspect" }, { slug: "vouchers" }, { slug: "config" }, { slug: "agents" }] },
        { label: "Reference", items: [{ slug: "commands" }, { slug: "flags-env" }, { slug: "exit-codes" }, { slug: "errors" }] },
